...
public class ResultProducer {
	...
	private KafkaProducer<String, Result> producer;
    ...
    private void init() {
        ...
        props.setProperty(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, ResultSerializer.class.getName());
    ...
    public void publish(String key, Result... messages) {
    	...
    	for (final Result message : messages) {
    		...
    		if (key == null) {
    			record = new ProducerRecord<>(resultTopic, message);
    		} else {
    			record = new ProducerRecord<>(resultTopic, key, message);	
    		}	
